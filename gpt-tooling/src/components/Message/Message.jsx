...
const Message = ({
  ...
  return (
    ...
    }} className={`px-4 py-2 rounded-md bg-blend-color-burn active:brightness-200 hover:cursor-pointer hover:brightness-150 relative hover:hue-rotate-90 transition duration-300 hover:duration-300`}>
